...
function syncPowershellUtils() {
    ...
    $newProfileContent = $(Invoke-WebRequest https://raw.githubusercontent.com/barnuri/dev-tools/master/powershell-utils/profileTools.psm1?noCache=$((Get-Date).ToString())).Content
